...
# 	Description: 																								  
	...
	string LCD_NameTag =     	"[LCD_Batteries]";     	//example: my LCD 31 [Battery Status LCD] 
	...
	bool OnlyBatteryWithNameTag =     	true;     	//false	= show all found Battery's attached, true = show only Battery's with Specific NameTag in their name 
	...
	string BatteryNameTag =     	"[VBattery]";     	// NameTag to show only specific Battery's, example: my Battery 15 [Battery-Status] 
